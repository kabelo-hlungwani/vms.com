...
$command="UPDATE staff SET password='$password' WHERE email='$email'and position='Photographer'";
...
<body style="background: rgb(191,34,58););">
    <div class="bg-white shadow login-card" style="background: rgb(255,255,255);margin-top: 110px;"><img class="border rounded-circle border-white profile-img-card" src="assets/img/pngaaa.com-4051919.png" style="width: 150px;height: 149px;">
        <p class="profile-name-card" style="font-size: 23px;color: rgb(191,34,58);font-family: Alata, sans-serif;font-weight: 60;">Create Password</p>
        <form class="form-signin" action="newp.php" name="form" onsubmit="return validateForm();" method="post">

            <input class="form-control" type="password" name="password" id="password"  placeholder="Password" autofocus="" style="border-top-color: rgb(191,34,58);border-right-color: rgb(191,34,58);border-bottom-color: rgb(191,34,58);border-left-color: rgb(191,34,58);font-family: Alata, sans-serif;"><span id="errorpass"></span>
            <input class="form-control" type="password" name="cpassword" id="cpassword"  placeholder="Confirm password" autofocus="" style="border-top-color: rgb(191,34,58);border-right-color: rgb(191,34,58);border-bottom-color: rgb(191,34,58);border-left-color: rgb(191,34,58);font-family: Alata, sans-serif;"><span id="ierror"></span>
    
            <button name="enter" class="btn btn-primary btn-block btn-lg btn-signin" type="submit" style="background: rgb(191,34,58);font-family: Alata, sans-serif;font-weight: 60;">Save password</button>
        </form><a class="forgot-password" href="otppassword.php" style="color: rgb(191,34,58);font-family: Alata, sans-serif;"><i class="far fa-arrow-alt-circle-left"></i>&nbsp;Back</a>
    </div>
