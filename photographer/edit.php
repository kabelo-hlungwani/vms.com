...
$qry=mysqli_query($conn,"select * from photograph WHERE photo_id='$id'");
...
echo '<script>alert("Image Updated.");window.location = "images.php";</script>';
                                            ...
                                            <div class="row register-form">
                                                <div class="col-md-8 offset-md-2">
                                                    <form data-aos="fade-up-left" class="custom-form" style="font-family: Alata, sans-serif;font-weight: 6;" enctype="multipart/form-data" name="form" action="" method="post">
                                                        ...
                                                        <div class="form-group files color"><input class="form-control-file"  type="file"  name="photo" style="background: rgb(255,255,255);" required=""></div>
