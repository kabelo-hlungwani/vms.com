...
$qry=mysqli_query($conn,"select * from super_admin WHERE sadmin_id='$id'");
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form action="" name="form" onsubmit="return validateForm();" method="post">
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="username" style="font-weight: 6;"><strong>Name</strong><br></label><input class="form-control" name="fname" value="<?php echo $data['first_name']?>" type="text" ></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="email" style="font-weight: 6;"><strong>Surname</strong><br></label><input class="form-control" type="text" name="lname"  value="<?php echo $data['last_name']?>" id="email" autocomplete="off"></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="first_name" style="font-weight: 6;">Id Number<br></label><input class="form-control" type="text" name="idno" value="<?php echo $data['id_number']?>" ></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="last_name" style="font-weight: 6;">Email<br></label><input class="form-control" type="text" name="email" id="email" value="<?php echo $data['email']?>" readonly=""></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="username" style="font-weight: 6;"><strong>Phone</strong><br></label><input class="form-control" value="<?php echo $data['phone']?>" name="phone" type="text" ></div>
                                                    </div>
                                                    <div class="col">
