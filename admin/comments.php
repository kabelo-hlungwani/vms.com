            ...
            <div id="content" style="opacity: 1;">
                ...
                <div class="container-fluid" style="opacity: 1;">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="mb-0" style="font-family: Alata, sans-serif;color: rgb(153,20,156);">Comments</h3>
                    </div>
                    <div class="row">
                        <div class="col">
                            <section class="mt-4">
                ...
                ?>
                                                          ...
                                                          ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <p><a href="delete.php?edt=<?php echo $rows['comment_id']  ?>" style="color: rgb(48,28,129);font-size: 14px;">Delete</a>&nbsp;<a href="reply.php?edt=<?php echo $rows['comment_id']  ?>" style="color: rgb(48,28,129);font-size: 14px;">Reply</a> </p>
                                                                    </td>
