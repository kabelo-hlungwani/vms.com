...
$qry=mysqli_query($conn,"select * from newsfeed WHERE news_id='$id'");
                                            ...
                                            <div class="row register-form">
                                                <div class="col-md-8 offset-md-2">
                                                    <form data-aos="fade-up-left" class="custom-form" style="font-family: Alata, sans-serif;font-weight: 6;" enctype="multipart/form-data" name="form" action="" method="post">
                                                        ...
                                                        <p style="font-size: 22px;color:rgb(153,20,156);">Update newsfeed</p>
                                                        ...
                                                        <div class="form-row form-group">
                                                            ...
                                                            <div class="col-sm-6 input-column"><input class="form-control" type="text" name="heading" required="" value="<?php  echo $data['heading'] ?>" style="border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-left-color: rgb(255,255,255);"></div>
                                                        </div>
                                                        <div class="form-row form-group">
                                                            ...
                                                            <div class="form-group">
                                                              <label for=""></label>
                                                              <textarea class="form-control" name="editor1" id="content" required="" rows="13"style="border-top-color: rgb(153,20,156);border-right-color: rgb(153,20,156);border-left-color: rgb(153,20,156);border-bottom-color: rgb(153,20,156);"><?php  echo $data['content'] ?></textarea>
                                                            </div>    
