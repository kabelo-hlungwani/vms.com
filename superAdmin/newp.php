...
$command="UPDATE super_admin SET password='$password' WHERE email='$email'";
...
<body style="background: url(&quot;assets/img/blue-abstract-background-images-hd.jpg&quot;);">
    <div class="bg-white shadow login-card" style="background: rgb(255,255,255);margin-top: 110px;"><img class="border rounded-circle border-white profile-img-card" src="assets/img/pngaaa.com-4051919.png" style="width: 150px;height: 149px;">
        <p class="profile-name-card" style="font-size: 23px;color: rgb(30,115,190);font-family: Alata, sans-serif;font-weight: 60;">Forgot Password?</p>
        <form class="form-signin" action="newp.php" name="form" onsubmit="return validateForm();" method="post">

            <input class="form-control" type="password" name="password" id="password"  placeholder="New password" autofocus="" style="border-top-color: rgb(29,119,218);border-right-color: rgb(29,119,218);border-bottom-color: rgb(29,119,218);border-left-color: rgb(29,119,218);font-family: Alata, sans-serif;"><span id="errorpass"></span>
            <input class="form-control" type="password" name="cpassword" id="cpassword"  placeholder="Confirm password" autofocus="" style="border-top-color: rgb(29,119,218);border-right-color: rgb(29,119,218);border-bottom-color: rgb(29,119,218);border-left-color: rgb(29,119,218);font-family: Alata, sans-serif;"><span id="ierror"></span>
    
            <button name="enter" class="btn btn-primary btn-block btn-lg btn-signin" type="submit" style="background: rgb(30,115,190);font-family: Alata, sans-serif;font-weight: 60;">Save password</button>
        </form><a class="forgot-password" href="otp.php" style="color: rgb(29,119,218);font-family: Alata, sans-serif;"><i class="far fa-arrow-alt-circle-left"></i>&nbsp;Back</a>
    </div>
