...
<?php
    ...
    if (mysqli_connect_errno())
      ...
      $qry="SELECT count(news_id) as totaladmin from newsfeed where staff_id='$id'";

      $res=mysqli_query($conn,$qry);
    
      $data=mysqli_fetch_array($res);

      $cmd="SELECT count(comment_id) as totalphotos from comment";
...
<?PHP
              ...
              $query="SELECT * from staff where email='$email'and position='Admin'";
            ...
            <div id="content" style="opacity: 1;background: #ffffff;">
                  ...
                  ?>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#"><span class="d-none d-lg-inline mr-2 text-gray-600 small" style="font-family: Alata, sans-serif;font-weight: 60;font-size: 13.8px;"><?php echo $rows['last_name'].' '. $rows['first_name'];?></span><img class="border rounded-circle img-profile" src="assets/img/password-key-pngrepo-com.png"></a>
                                    <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in"><a class="dropdown-item" href="profile.php?edt=<?php echo $rows['staff_id'] ?>"><i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Profile</a><a class="dropdown-item" href="news.php"><i class="far fa-save fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Manage News</a><a class="dropdown-item" href="comments.php"><i class="far fa-save fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Manage Comments</a>
                ...
                <div class="container-fluid" style="opacity: 1;">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="mb-0" style="font-family: Alata, sans-serif;color: rgb(153,20,156);border-left-color: rgb(255, 255, 255);font-weight: 6;">Admin</h3>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            ...
                                            <div class="text-uppercase text-primary font-weight-bold text-xs mb-1"><span style="font-weight: 60;">News feeds</span></div>
                                            <div class="text-dark font-weight-bold h5 mb-0"><span style="font-weight: 60;"><?php echo $data['totaladmin']?></span></div>
                                        </div>
                                        <div class="col-auto"> <i class="far fa-newspaper fa-2x text-gray-300" style="color: rgb(18,41,178);"></i></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-left-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span style="font-weight: 6;">Comments</span></div>
