...
<body style="background: rgb(191,34,58););">
    <div class="bg-white shadow login-card" style="background: rgb(255,255,255);margin-top: 110px;"><img class="border rounded-circle border-white profile-img-card" src="assets/img/pngaaa.com-4051919.png" style="width: 150px;height: 149px;">
        <p class="profile-name-card" style="font-size: 23px;color: rgb(191,34,58);font-family: Alata, sans-serif;font-weight: 60;">Forgot Password?</p>
        <form class="form-signin" action="newp.php" name="form" onsubmit="return validateForm();" method="post">

            <input class="form-control" type="password" name="password" id="password"  placeholder="New password" autofocus="" style="border-top-color: rgb(191,34,58);border-right-color: rgb(191,34,58);border-bottom-color: rgb(191,34,58);border-left-color: rgb(191,34,58);font-family: Alata, sans-serif;"><span id="errorpass"></span>
        ...
        </form><a class="forgot-password" href="otp.php" style="color: rgb(191,34,58);font-family: Alata, sans-serif;"><i class="far fa-arrow-alt-circle-left"></i>&nbsp;Back</a>
    </div>
