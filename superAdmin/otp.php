...
<body style="background: url(&quot;assets/img/blue-abstract-background-images-hd.jpg&quot;);">
    <div class="bg-white shadow login-card" style="background: rgb(255,255,255);margin-top: 110px;"><img class="profile-img-card" src="assets/img/password-key-pngrepo-com.png" style="width: 150px;height: 149px;">
        ...
        <form class="form-signin" action="" name="form" onsubmit="return validateForm();" method="post">
            ...
            <p style="font-family: Alata, sans-serif;color: rgb(30,115,190);font-weight: 60;"><strong>OTP code sent to your email Verify?</strong></p>
            <p style="font-family: Alata, sans-serif;color: rgb(30,115,190);"><i class="fas fa-user-lock"></i>&nbsp;<?php echo $email; ?></p><input class="form-control" type="number" id="otp" name="otp" placeholder="OTP" style="border-top-color: rgb(29,119,218);border-right-color: rgb(29,119,218);border-bottom-color: rgb(29,119,218);border-left-color: rgb(29,119,218);font-family: Alata, sans-serif;"><span id="uerror"></span>
            <br>
            <div class="checkbox"></div>
            <button class="btn btn-primary btn-block btn-lg btn-signin" type="submit"  style="background: rgb(30,115,190);font-family: Alata, sans-serif;font-weight: 60;">Confirm Sign Up&nbsp;<i class="fab fa-expeditedssl btn-signin"></i></button>
        </form>
    </div>
